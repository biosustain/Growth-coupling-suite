...
output_dir = os.getcwd() + "/results_single" # directory in which results are saved
output_file_id = "succinate_gc_i5_k4_a4_cs1_cf1"
...
# solver specific
time_limit = 30 # runtime limit of (gurobi) solver [sec]
processes = 2 # number of threads gurobi is using
...
directionality_assessment = False
